            ...
            if (Intro)
            {
                if (uiIntroTimer <= diff)
                {
                    switch (uiIntroPhase)
                    {
                        case 0:
                            uiIntroTimer = 5000;
							Talk(AUGH_SAY_HOW_YOU_KILL_CROCK, me);
                            break;
                        case 1:
							Talk(AUGH_SAY_AUGH_SMART, me);
                            uiIntroTimer = 9000;
                            break;
                        case 2:
                            {
								Talk(AUGH_SAY_AUGH_BOSS, me);
                                uiIntroTimer = 5000;
                            ...
                            break;
                        case 3:
							Talk(AUGH_SAY_AUGH_STEAL, me);
                            uiIntroTimer = 7000;
                            break;
                        case 4:
							Talk(AUGH_SAY_AUGH_BAD, me);
                            Intro = false;
                            break;
                    }

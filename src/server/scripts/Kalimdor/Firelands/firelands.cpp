                        ...
                        for (Map::PlayerList::const_iterator itr = PlayerList.begin(); itr != PlayerList.end(); ++itr)
                        {
                            if (Player* pPlayer = itr->GetSource())
                            {
                                ...
                                if (!(pPlayer->getClass() == CLASS_MAGE ||
                                    ...
                                    (pPlayer->getClass() == CLASS_SHAMAN && (pPlayer->GetPrimaryTalentTree(pPlayer->GetActiveSpec()) == CHAR_SPECIALIZATION_SHAMAN_ELEMENTAL || pPlayer->GetPrimaryTalentTree(pPlayer->GetActiveSpec()) == CHAR_SPECIALIZATION_SHAMAN_RESTORATION)) ||
                                    (pPlayer->getClass() == CLASS_DRUID && (pPlayer->GetPrimaryTalentTree(pPlayer->GetActiveSpec()) == CHAR_SPECIALIZATION_DRUID_BALANCE || pPlayer->GetPrimaryTalentTree(pPlayer->GetActiveSpec()) == CHAR_SPECIALIZATION_DRUID_RESTORATION))))
                                    continue;

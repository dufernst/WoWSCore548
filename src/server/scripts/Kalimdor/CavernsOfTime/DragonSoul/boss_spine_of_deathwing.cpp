    ...
    public:
        ...
        private:
            ...
            void DoRoll(uint8 side /* 1 - left, 2 - right*/)
            {
                ...
                SkyMistCore::PlayerListSearcher<AnyLivePlayerNoGmCheck> searcher(me, players, check);
    ...
    public:
        ...
        struct npc_spine_of_deathwing_spawnerAI : public Scripted_NoMovementAI
        {
            ...
            void KilledUnit(Unit* who)
            {
                ...
                {
                    who->ToPlayer()->UpdateAchievementCriteria(ACHIEVEMENT_CRITERIA_TYPE_BE_SPELL_TARGET, 94644, 0, 0,  who->ToPlayer());
                    who->ToPlayer()->UpdateAchievementCriteria(ACHIEVEMENT_CRITERIA_TYPE_BE_SPELL_TARGET2, 94655, 0, 0,  who->ToPlayer());
                }
            }
        };
};

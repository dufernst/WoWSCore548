                    ...
                    bool operator()(WorldObject* unit)
                    {
                        ...
                        switch (unit->ToPlayer()->getClass())
                        {
                            ...
                            case CLASS_HUNTER:
                                return true;
                            case CLASS_DRUID:
                                if (unit->ToPlayer()->GetPrimaryTalentTree(unit->ToPlayer()->GetActiveSpec()) == CHAR_SPECIALIZATION_DRUID_FERAL)
                                    return true;
                                return false;
                            case CLASS_PALADIN:
                                if (unit->ToPlayer()->GetPrimaryTalentTree(unit->ToPlayer()->GetActiveSpec()) == CHAR_SPECIALIZATION_PALADIN_HOLY)
                                    return false;
                                return true;
                            default:
                                return false;

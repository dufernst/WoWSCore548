...
CREATE TABLE `account_battle_pet` (
  ...
  `nickname` varchar(16) COLLATE utf8_bin NOT NULL DEFAULT '',
...
/*Table structure for table `character_rated_matchmaker_rating` */
...
/*Data for the table `character_rated_matchmaker_rating` */

/*Table structure for table `character_rated_stats` */
...
/*Data for the table `character_rated_stats` */
